...
def load_trade_data(engine, hours: int = 24) -> pd.DataFrame:
    ...
    query = f"""
        SELECT 
            ...
            b.our_status,
            t.minute,
            t.pm_price_change_1m, t.pm_momentum_volatility_ratio, t.pm_momentum_acceleration_1m,
            t.pm_price_change_5m, t.pm_price_change_10m, t.pm_volatility_pct,
            t.pm_body_range_ratio, t.pm_volatility_surge_ratio, t.pm_price_stddev_pct,
            t.pm_trend_consistency_3m, t.pm_cumulative_return_5m, t.pm_candle_body_pct,
            t.pm_upper_wick_pct, t.pm_lower_wick_pct, t.pm_wick_balance_ratio,
            t.pm_price_vs_ma5_pct, t.pm_breakout_strength_10m,
            t.pm_open_price, t.pm_high_price, t.pm_low_price, t.pm_close_price, t.pm_avg_price,
            t.ob_mid_price, t.ob_price_change_1m, t.ob_price_change_5m, t.ob_price_change_10m,
            t.ob_volume_imbalance, t.ob_imbalance_shift_1m, t.ob_imbalance_trend_3m,
            t.ob_depth_imbalance_ratio, t.ob_bid_liquidity_share_pct, t.ob_ask_liquidity_share_pct,
            t.ob_depth_imbalance_pct, t.ob_total_liquidity, t.ob_liquidity_change_3m,
            t.ob_microprice_deviation, t.ob_microprice_acceleration_2m, t.ob_spread_bps,
            t.ob_aggression_ratio, t.ob_vwap_spread_bps, t.ob_net_flow_5m,
            t.ob_net_flow_to_liquidity_ratio, t.ob_sample_count, t.ob_coverage_seconds,
            t.tx_buy_sell_pressure, t.tx_buy_volume_pct, t.tx_sell_volume_pct,
            t.tx_pressure_shift_1m, t.tx_pressure_trend_3m, t.tx_long_short_ratio,
            t.tx_long_volume_pct, t.tx_short_volume_pct, t.tx_perp_position_skew_pct,
            t.tx_long_ratio_shift_1m, t.tx_perp_dominance_pct, t.tx_total_volume_usd,
            t.tx_volume_acceleration_ratio, t.tx_volume_surge_ratio, t.tx_whale_volume_pct,
            t.tx_avg_trade_size, t.tx_trades_per_second, t.tx_buy_trade_pct,
            t.tx_price_change_1m, t.tx_price_volatility_pct, t.tx_cumulative_buy_flow_5m,
            t.tx_trade_count, t.tx_large_trade_count, t.tx_vwap,
            t.wh_net_flow_ratio, t.wh_flow_shift_1m, t.wh_flow_trend_3m,
            t.wh_accumulation_ratio, t.wh_strong_accumulation, t.wh_cumulative_flow_5m,
            t.wh_total_sol_moved, t.wh_inflow_share_pct, t.wh_outflow_share_pct,
            t.wh_net_flow_strength_pct, t.wh_strong_accumulation_pct, t.wh_strong_distribution_pct,
            t.wh_activity_surge_ratio, t.wh_movement_count, t.wh_massive_move_pct,
            t.wh_avg_wallet_pct_moved, t.wh_largest_move_dominance, t.wh_distribution_pressure_pct,
            t.wh_outflow_surge_pct, t.wh_movement_imbalance_pct,
            t.wh_inflow_sol, t.wh_outflow_sol, t.wh_net_flow_sol,
            t.wh_inflow_count, t.wh_outflow_count, t.wh_massive_move_count,
            t.wh_max_move_size, t.wh_strong_distribution,
            t.pat_breakout_score, t.pat_detected_count,
            t.pat_asc_tri_detected, t.pat_asc_tri_confidence, t.pat_asc_tri_compression_ratio,
            t.pat_asc_tri_resistance_level, t.pat_asc_tri_support_level,
            t.pat_bull_flag_detected, t.pat_bull_flag_confidence,
            t.pat_bull_flag_pole_height_pct, t.pat_bull_flag_retracement_pct,
            t.pat_bull_pennant_detected, t.pat_bull_pennant_confidence, t.pat_bull_pennant_compression_ratio,
            t.pat_fall_wedge_detected, t.pat_fall_wedge_confidence, t.pat_fall_wedge_contraction,
            t.pat_cup_handle_detected, t.pat_cup_handle_confidence, t.pat_cup_handle_depth_pct,
            t.pat_inv_hs_detected, t.pat_inv_hs_confidence, t.pat_inv_hs_neckline,
            t.sp_price_count, t.sp_min_price, t.sp_max_price, t.sp_start_price, t.sp_end_price,
            t.sp_price_range_pct, t.sp_total_change_pct, t.sp_volatility_pct, t.sp_avg_price,
            t.btc_price_change_1m, t.btc_price_change_5m, t.btc_price_change_10m,
            t.btc_volatility_pct, t.btc_open_price, t.btc_close_price,
            t.eth_price_change_1m, t.eth_price_change_5m, t.eth_price_change_10m,
            t.eth_volatility_pct, t.eth_open_price, t.eth_close_price
